...
class Lyrics extends Component {
  ...
  render() {
    ...
    if (
      ...
      return (
        <React.Fragment>
          <Link to="/" className="btn btn-sm mb-4 button_color ">
            Go Back!
          </Link>
          <div className="card">
            <h5 className="card-header card_header_styling">
              <strong>{track.track_name} by </strong>
              <span className="text-primary">{track.artist_name}</span>
            </h5>
            <div className="card-body card_body_styling">
